...
public class DateUtil {
	...
	public static final int ZERO_MINUTE = 0; 
	public static final int ZERO_SECOND = 0; 
	public static final int TWENTY_THREE_HOUR = 23; 
	public static final int FIFTY_NINE_MINUTE = 59; 
	public static final int FIFTY_NINE_SECOND = 59; 
    ...
    public static Date fmtStrToDate(String dtFormat) {
        if (dtFormat == null || "".equals(dtFormat.trim())) {
            return null;
        }
        try {
    ...
    public static String getNowTime(){
        return fmtDateToStr(new Date(), "HHmmss");
    }
    
    public static String getTime(){
        return fmtDateToStr(new Date(), "yyyyMMddHHmmssSSS");
    }
    public static String getNowTimes(){
        return fmtDateToStr(new Date(), "yyyy-MM-dd HH:mm:ss");
    }
     ...
     * @since：2007-7-10 上午11:24:00
     */
    public static String fmtDateToStr(String dtFormat) {
        try {
            SimpleDateFormat dateFormat = new SimpleDateFormat(dtFormat);
    ...
    public static Date setFirstSecondOfDay(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(date);
    	cl.set(Calendar.HOUR_OF_DAY, ZERO_HOUR);
    	cl.set(Calendar.MINUTE, ZERO_MINUTE);
    	cl.set(Calendar.SECOND, ZERO_SECOND);
    	return cl.getTime();
    }
    public static Date setLastSecondOfDay(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(date);
    	cl.set(Calendar.HOUR_OF_DAY, TWENTY_THREE_HOUR);
    	cl.set(Calendar.MINUTE, FIFTY_NINE_MINUTE);
    	cl.set(Calendar.SECOND, FIFTY_NINE_SECOND);
    	return cl.getTime();
    }
     ...
     * @since  1.0.0
     */
    public static String getFirstSecondOfYear(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(getYearStart(date));
    	cl.setTime(setFirstSecondOfDay(cl.getTime()));
    	return fmtDateToYMDHMS(cl.getTime());
    }
     ...
     * @since  1.0.0
     */
    public static String getLastSecondOfYear(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(getLastDayOfYear(date));
    	cl.setTime(setLastSecondOfDay(cl.getTime()));
    	return fmtDateToYMDHMS(cl.getTime());
    }
     ...
     * @since  1.0.0
     */
    public static String getFirstSecondOfMonth(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(date);
     ...
     * @since  1.0.0
     */
    public static String getLastSecondOfMonth(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(getLastDayOfMonth(date));
    	cl.setTime(setLastSecondOfDay(cl.getTime()));
    	return fmtDateToYMDHMS(cl.getTime());
    }
     ...
     * @since  1.0.0
     */
    public static String getFirstSecondOfDay(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(date);
    	cl.setTime(setFirstSecondOfDay(cl.getTime()));
    	return fmtDateToYMDHMS(cl.getTime());
     ...
     * @since  1.0.0
     */
    public static String getLastSecondOfDay(Date date) {
    	Calendar cl = Calendar.getInstance();
    	cl.setTime(setLastSecondOfDay(cl.getTime()));
    	return fmtDateToYMDHMS(cl.getTime());
    }
