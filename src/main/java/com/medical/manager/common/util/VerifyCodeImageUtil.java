...
public class VerifyCodeImageUtil {
    ...
    /**
     * generateVerifyCodeImage 生成图片验证码
     * (这里描述这个方法适用条件 – 可选)
     ...
     * @since  1.0.0
     */
    public static BufferedImage generateVerifyCodeImage(String createTypeFlag){
        if(StringUtil.isEmpty(createTypeFlag)){
            createTypeFlag = "n";
        }
        //1.在内存中创建一张图片
    ...
    public static void setRandom(String random) {
        VerifyCodeImageUtil.random = random;
    }
